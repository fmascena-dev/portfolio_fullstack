...
export default function JanelaChat() {
	...
	return (
		<div className="flex flex-col bg-zinc-300 rounded-2xl text-black overflow-hidden">
			...
			{mensagens.length === 0 ? (
				<div className="flex flex-col justify-center items-center min-h-[200px] sm:min-h-[350px]">
					<IconMessages size={230} stroke={0.2} className="text-black/30" />
					<span>Vamos conversar?</span>
				</div>
			) : (
				<div className="flex flex-col p-2 gap-2 min-h-[200px] sm:min-h-[350px] max-h-[350px] sm:max-h-[350px] overflow-y-scroll">
